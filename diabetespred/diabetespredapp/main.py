...
def train():
    f = []
    data = pd.read_csv("diabetespredapp/diabetes.csv")  # Dataset converted as a pandas data frame
    acc = []
    ...
    fig.savefig('diabetespredapp/static/logic.jpg')
    print(cm)
    acc.append(accuracy)
    ...
    fig = plt.figure()
    sns.heatmap(cm, annot=labels, fmt='')
    fig.savefig('diabetespredapp/static/adaboost.jpg')
    print(cm)
    acc.append(accuracy)
    ...
    fig = plt.figure()
    sns.heatmap(cm, annot=labels, fmt='')
    fig.savefig('diabetespredapp/static/randomforest.jpg')
    print(cm)
    acc.append(accuracy)
    ...
    fig = plt.figure()
    sns.heatmap(cm, annot=labels, fmt='')
    fig.savefig('diabetespredapp/static/tree.jpg')
    print(cm)
    acc.append(accuracy)
    ...
    fig = plt.figure()
    sns.heatmap(cm, annot=labels, fmt='')
    fig.savefig('diabetespredapp/static/nb.jpg')
    print(cm)
    acc.append(accuracy)
    ...
    fig = plt.figure()
    sns.heatmap(cm, annot=labels, fmt='')
    fig.savefig('diabetespredapp/static/knn.jpg')
    print(cm)
    acc.append(accuracy)
